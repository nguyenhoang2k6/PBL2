...
bool AdminDashBoard::Init() {
    ...
    button_hoadon = new Button(720.0f, 1200.0f, 500.0f, 175.0f, COLOR_UI_TURQUOISE, "Xuất Hóa Đơn", renderer, font2, COLOR_WHITE);
    ...
    button_back = new Button(1512.0f, 1200.0f, 500.0f, 175.0f, COLOR_UI_RED, "Đăng Xuất", renderer, font2, COLOR_WHITE);


    if (!label_title ||!button_nv ||!button_item ||!button_hoadon ||!button_thongke ||!button_doimk ||!button_back) {
